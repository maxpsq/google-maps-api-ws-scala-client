# Google Maps API client on Scala [![Build Status](https://travis-ci.org/maxpsq/google-maps-api-ws-scala-client.svg?branch=master)](https://travis-ci.org/maxpsq/google-maps-api-ws-scala-client)
